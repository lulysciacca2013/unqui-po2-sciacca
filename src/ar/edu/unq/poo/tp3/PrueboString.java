...
public class PrueboString {
	...
	public static void main(String[] args) {
		...
		System.out.println("Quilmes".substring(2, 4)); // devuelve il, toma las primeras 4 letras y de ese substring
														// devuelve lo que estan a partir de la 2da letra
		System.out.println((a.length() + a).startsWith("a")); // devuelve false, la primera parte es 3abc y al aplicar
																// la funcion startswith no es "a"
